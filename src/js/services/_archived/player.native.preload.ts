/**
 * [NOTE]
 * The preloading functionality never went live, and now I want to move to a player that
 * supports transcoding, so I'm archiving this code for potential future reference.
 */
